            ...
            <div class="container px-5  mx-auto md:px-0 lg:px-20">
                ...
                <header class="md:flex justify-between items-center hidden ">
                    ...
                    <ul class=" flex gap-x-10 items-center">
                        <li><a href="#" class="font-title font-bold">Home</a></li>
                        <li><a href="#" class="font-title">Doctors</a></li>
                        <li><a href="#" class="font-title">How Its Work</a></li>
                        <li><a href="#" class="font-title">Contact</a></li>
                    </ul>
                    <!-- button -->
                    <div class="">
                        <a href="appointment"><button
                                class="text-black px-6  bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Book
                ...
                <div class="md:flex justify-center items-center md:text-center">
                    ...
                    <div class="">
                        <div class="md:pt-10 pt-24">
                            <h1 class="text-2xl font-bold font-title">Welcome to Gracias Clinic <span
                                    class="md:block pt-2"></span>Your Health Matters, Any time, Any where.
                            </h1>
                        </div>
                        <div class="pt-8">
                            <p class=" text-lg">Experience personalized healthcare at your fingertips. No more travel,
                                no
                                more
                        ...
                        <div class="pt-8 pb-2">
                            <a href="appointment"> <button
                                    class="text-black w-full md:w-1/2   bg-[#A4CB6A] font-semibold mb-6  text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Book
                                    Your Online Consultation Now</button>
                            </a>
                        </div>
        ...
        <div class="bg-[#212245]">
            ...
            <div class="container mx-auto px-5 md:px-20">
                ...
                <div class="md:py-10 pb-14 md:pb-0">
                    ...
                    <div class=" md:grid grid-cols-3 gap-x-10 md:pb-16 md:pt-10">
                        <!--grid start-->
                        <!-- 1 -->
                        ...
                        <div class="text-center  py-12">
                            ...
                            <div>
                                ...
                                <p class="text-sm pt-3 text-[#D9D9D9]">Get medical advice from experienced
                                    professionals, no
                                    matter where you live. This is particularly useful for those in remote areas or who
                                    are
        ...
        <div>
            ...
            <div class="container mx-auto px-5 md:px-20">
                ...
                <div class="">
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-x-48 gap-y-5 md:mt-16" x-data='{
                        tab: 1
                        }'>
                        <!--grid-->
                        <!-- 1 -->
                        ...
                        <div class="mt-10 md:mt-0">
                            ...
                            <div class=" border-[#878787] border border-t-0 px-5   mb-4  rounded-b-lg ">
                                ...
                                <p class="text-[#878787] pt-5 ">He is a board-certified physician with over 15 years of
                                    ...
                                    dedicated to providing comprehensive and personalized care to his patients. His
                                    clinical
                                    interests include preventive care, chronic disease management, and health promotion
                                    through lifestyle modification. Dr. Emanuel believes in building strong
                                    relationships
                                ...
                                <div class=" flex justify-center mt-8">
                                    <button
                                        class="text-black md:w-5/6 bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">
                                        <a href="appointment" @click="tab = 1">Book With Dr. Emanuel</a>
                                    </button>
                        ...
                        <div class="">
                            ...
                            <div class="border-[#878787] border border-t-0 px-5  mb-4 rounded-b-lg ">
                                ...
                                <div class=" flex justify-center mt-8">
                                    <button @click="tab = 2"
                                        class="text-black md:w-5/6 bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l"><a
                ...
                <div class="">
                    ...
                    <div class="mt-10 grid md:grid-cols-2 grid-cols-1 gap-x-16 gap-y-8 md:gap-y-3 md:py-10 pb-12">
                        ...
                        <!-- 1 -->
                        <div class="border border-black rounded-md p-5 shadow-[3px_3px_black]">
                            <!--border-->
                            <!-- star icon -->
    ...
    <div class="bg-[#212245]">
        ...
        <div class="container mx-auto px-5 md:px-20">
            ...
            <div class="md:py-10  md:pb-0">
                ...
                <div class="grid md:grid-cols-3 grid-cols-1 gap-x-10 md:pb-16 md:pt-10">
                    <!--grid start-->
                    <!-- 1 -->
                    <div class="text-center py-12">
                        <!-- icon -->
                ...
                <div class="container mx-auto md:px-20 md:pt-10">
                    <div class="mt-8">
                        ...
                        <div>
                            ...
                            <p>Our online consultations are not intended for emergency situations. If you believe you
                                are
                ...
                <div class="md:py-12">
                    ...
                    <footer class="pt-4 md:pt-0 grid md:grid-cols-3 grid-cols-1 ">
                        ...
                        <div class="pt-8 md:pt-0">
                            ...
                            <div>
                                <p class="text-[#878787] text-base font-semibold mt-5 md:text-center">We're here to
                                    help! If
                                    you have any
                        ...
                        <div class="mt-16 md:mt-0">
                            ...
                            <p class="text-[#878787] text-base  font-semibold mt-6 md:text-center">Stay up to- date on
                                health tips, news and
    ...
    <div class="container mx-auto px-20 hidden md:block">
        ...
        <div class="flex justify-between items-center">
            ...
            <ul class=" flex gap-x-10 items-center">
                ...
                <li><a href="#" class="font-semibold">Doctors</a></li>
                <li><a href="#" class="font-semibold">How Its Work</a></li>
                <li><a href="#" class="font-semibold">Contact</a></li>
            </ul>
